...
export const ERROR_TYPE = {
  ...
  CAR_NAME_LENGTH_IS_OVER_FIVE: 'CAR_NAME_LENGTH_IS_OVER_FIVE',
  CAR_NAME_IS_OVERLAPED: 'CAR_NAME_IS_OVERLAPED',
  /* 시도횟수 */
...
export const ERROR_MESSAGE = {
  ...
  CAR_NAME_LENGTH_IS_OVER_FIVE: '[ERROR] 자동차 이름은 5글자 이하로 설정할 수 있습니다.',
  CAR_NAME_IS_OVERLAPED: '[ERROR] 중복된 자동차 이름이 있습니다.',
  /* 시도횟수 */
