...
export function chooseErrorMessage(type) {
  ...
  if (type === ERROR_TYPE.CAR_NAME_LENGTH_IS_OVER_FIVE) {
    return ERROR_MESSAGE.CAR_NAME_LENGTH_IS_OVER_FIVE;
  }
  if (type === ERROR_TYPE.CAR_NAME_IS_OVERLAPED) return ERROR_MESSAGE.CAR_NAME_IS_OVERLAPED;
  /* 시도횟수 */
